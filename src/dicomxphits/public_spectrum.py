...
PUBLIC_BEAM_MODEL_ID = "elekta_precise_6mv_public_research"
PUBLIC_BEAM_MODEL_DISPLAY_NAME = "Elekta Precise 6 MV public research model"
PUBLIC_BEAM_MODEL_RADIATION_TYPE = "PHOTON"
PUBLIC_BEAM_MODEL_NOMINAL_ENERGY_MV = 6.0
PUBLIC_BEAM_MODEL_IS_FIXED = True
PUBLIC_BEAM_MODEL_GUI_LINE = f"Beam model: {PUBLIC_BEAM_MODEL_DISPLAY_NAME}"
PUBLIC_BEAM_MODEL_ENERGY_GUI_LINE = "Nominal energy: 6 MV (fixed)"
