...
Status: proposed; awaiting approval before implementation. This change remains
active until implementation, acceptance checks, and required archive closeout.
