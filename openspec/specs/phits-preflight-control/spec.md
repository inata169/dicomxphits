# phits-preflight-control Specification

## Purpose

Define invocation-owned, responsive PHITS preflight and preparation
cancellation using bounded workspace and selected-executable evidence, while
keeping mutable progress artifacts non-authorizing and preserving all result,
stop, ownership and downstream gates.
