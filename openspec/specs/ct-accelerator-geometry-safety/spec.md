# ct-accelerator-geometry-safety Specification

## Purpose

Define fail-closed composition and validation of mutually exclusive CT and
accelerator regions in the public fixed-field PHITS geometry.
