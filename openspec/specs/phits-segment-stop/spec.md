# phits-segment-stop Specification

## Purpose
Define owned, verifiable stopping at a PHITS segment boundary and explicit
continuation through the incomplete-segment workflow, without child termination
or reuse of partial statistics.
## Requirements
