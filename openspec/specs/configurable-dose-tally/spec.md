# Configurable Dose Tally Specification

## Purpose

Define the safe, versioned calculation configuration for deriving one regular
3D PHITS dose tally mesh per public fixed-field 3D-CRT workspace while
preserving the legacy default, PDD tally, and actual-output-based downstream
geometry authority.
